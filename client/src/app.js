      ...
      Ball.prototype.update = function(playerPaddle, computerPaddle) {
        ...
        if(leftEdge_X < 450) 
          ...
          console.log(playerPaddle.x + playerPaddle.width)
            ...
            if(leftEdge_X < (playerPaddle.x + playerPaddle.width)
              && rightEdge_Y > playerPaddle.y
              && leftEdge_Y < (playerPaddle.y + playerPaddle.height)
              && rightEdge_X > playerPaddle.x
              ) 
            {
          ...
          //Computer
            ...
            if(leftEdge_X > (computerPaddle.x + computerPaddle.width - 15)
        
              && rightEdge_Y > computerPaddle.y
              && leftEdge_Y < (computerPaddle.y + computerPaddle.height)
              && rightEdge_X > computerPaddle.x
            )
            {
